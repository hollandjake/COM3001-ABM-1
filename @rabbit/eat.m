...
%ENV_DATA is a data structure containing information about the model
   ...
   %    ENV_DATA.pollen is  a bm_size x bm_size array containing distribution of food
...
pfood=ENV_DATA.pollen(cpos(1),cpos(2));   %obtain environment food level at current location

if pfood>=1                             %if food exists at this location
    ENV_DATA.pollen(cpos(1),cpos(2))=ENV_DATA.pollen(cpos(1),cpos(2))-1;  %reduce environment food by one unit
